...
class CustomAttnProcessorV2(AttnProcessor2_0):
    def __init__(self, controller, place_in_unet: str):
        super().__init__()
    ...
    def __call__(
        ...
        **kwargs,
        ...
        attn_weights = self.controller(attn_weights, is_cross, self.place_in_unet)
...
def register_attention_control_v2(pipe, controller):
