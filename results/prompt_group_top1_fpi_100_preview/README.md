...
- Manifest snapshots: `best_manifest_snapshot.csv`, `worst_manifest_snapshot.csv`

The full run also writes latent `.pt` files, but those are intentionally not included here.
